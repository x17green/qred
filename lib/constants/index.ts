...
export const STORAGE_KEYS = {
  AUTH_TOKEN: "@qred:auth_token",
  USER_DATA: "@qred:user_data",
  ONBOARDING_COMPLETED: "@qred:onboarding_completed",
  BIOMETRIC_ENABLED: "@qred:biometric_enabled",
  THEME_PREFERENCE: "@qred:theme_preference",
};

// App Configuration
export const APP_CONFIG = {
  NAME: "Qred",
  TAGLINE: "Your credit, simplified",
  VERSION: "1.0.0",
